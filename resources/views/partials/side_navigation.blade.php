...
<div class="media leftpanel-profile">
    <div class="media-left">
        <a href="#">
            <img src="{{asset("img/user.png")}}" alt="" class="media-object img-circle">
        </a>
    </div>
    <div class="media-body">
        <h4 class="media-heading"> Guest <a data-toggle="collapse" data-target="#loguserinfo" class="pull-right"><i class="fa fa-angle-down"></i></a></h4>
        <span>Guest</span>
    </div>
...
<div class="tab-content">
    ...
    <div class="tab-pane active" id="mainmenu">
        ...
        <ul class="nav nav-pills nav-stacked nav-quirk">
            ...
            <li class="nav-parent">
                <a href="#"><i class="fa fa-check-square"></i> <span>Base Details</span></a>
                <ul class="children">
                    <li><a href="{{route("add_base_details")}}">Add Base Details</a></li>
                    <li><a href="{{route("view_base_details")}}">View Base Details</a></li>
                </ul>
            </li>
            <li class="nav-parent">
                <a href="#"><i class="fa fa-suitcase"></i> <span>Field Details</span></a>
                <ul class="children">
                    <li><a href="{{route("add_fields_description")}}">Add Fields Details</a></li>
                    <li><a href="{{route("view_field_details")}}">View Fields Details</a></li>
                </ul>
            </li>
        </ul>
    </div><!-- tab-pane -->
